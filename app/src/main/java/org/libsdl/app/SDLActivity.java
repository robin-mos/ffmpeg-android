...
public class SDLActivity extends Activity {
    ...
    protected Button mPlayBtn ,mMuteBtn, mPreBtn,mNextBtn,mFullBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        LogUtils.e(SDLActivity.class.getName(), "Device: " + android.os.Build.DEVICE);
        LogUtils.e(SDLActivity.class.getName(), "Model: " + android.os.Build.MODEL);
        LogUtils.e(SDLActivity.class.getName(), "onCreate()");
    ...
    protected void onPause() {
        LogUtils.e(SDLActivity.class.getName(), "onPause()");
        super.onPause();
    ...
    private void initView(){
        mSurface = (SDLSurface) findViewById(R.id.sdlsurface);
        mPlayBtn = (Button) findViewById(R.id.play);
        mPreBtn = (Button) findViewById(R.id.pre);
        mNextBtn = (Button) findViewById(R.id.next);
        mMuteBtn = (Button) findViewById(R.id.mute);
        mFullBtn = (Button) findViewById(R.id.full);
        ...
        mMuteBtn.setOnClickListener(mBtnClickListener);
        mFullBtn.setOnClickListener(mBtnClickListener);
    }
    ...
    private View.OnClickListener mBtnClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            switch (v.getId()){
                case R.id.play:
                    onNativeKeyDown(KeyEvent.KEYCODE_BREAK);
                    break;
                case R.id.pre:
...
class SDLMain implements Runnable {
    ...
    public void run() {
        ...
        LogUtils.e(this.getClass().getName(), "Running main function " + function + " from library " + library);
        //SDLActivity.nativeRunMain(library, function, arguments);
        String[] argv = new String[]{SDLActivity.mPath};

        StarPlayerSystem.main(0,(Object) argv);
        LogUtils.e(this.getClass().getName(), "Finished main function");
    }
}
...
class SDLSurface extends SurfaceView implements SurfaceHolder.Callback,
    ...
    public SDLSurface(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes){
